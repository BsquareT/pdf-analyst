...
export default function Layout({ children, user, profile, onProfileUpdate }) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0c0c0c' }}>
      ...
      <nav style={{
        ...
        {user && profile && (
          <div style={{
            padding: '18px 20px', borderTop: '1px solid #1e1e1e',
          }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14 }}>
              ...
              <div style={{
                ...
                fontFamily: "'IBM Plex Mono',monospace",
                fontSize: '0.75rem', color: '#c9a86c', flexShrink: 0,
              }}>
                {initials}
              </div>
            ...
            <div style={{
              background: '#17150e', border: '1px solid #2e2a1e',
            ...
            <button
              ...
              onMouseOver={e => { e.target.style.borderColor='#d95f5f'; e.target.style.color='#d95f5f'; }}
